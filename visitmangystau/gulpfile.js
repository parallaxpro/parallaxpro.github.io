...
let paths = {
	...
	scripts: {
		src: [
			baseDir + '/libs/jquery-3.5.1.min.js',
	...
	images: {
		src:  baseDir + '/assets/frontend/images/src/**/*',
		dest: baseDir + '/assets/frontend/images/dest',
	},
...
function startwatch() {
	...
	watch(baseDir  + '/assets/frontend/images/src/**/*.{' + imageswatch + '}', {usePolling: true}, images);
